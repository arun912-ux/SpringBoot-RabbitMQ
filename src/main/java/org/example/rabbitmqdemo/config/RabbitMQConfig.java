...
public class RabbitMQConfig {
    ...
    public TopicExchange amqTopicExchange() {
        return new TopicExchange(mqttExchange, true, false);
    }
...
//
//        // treat null contentType the same as “application/octet-stream”
//        converter.addDelegate("application/json", new JacksonJsonMessageConverter());
//        converter.addDelegate(null, new SimpleMessageConverter());
//        return converter;
//    }
}
